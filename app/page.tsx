...
import { employeeData } from "../app/form/form-data";
...
const findEmployeeData = (id: string) => {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      {/* Right side */}
      <div className="w-full xl:w-1/2 flex items-center justify-center bg-gray-50 py-4 h-[100vh] overflow-auto">
